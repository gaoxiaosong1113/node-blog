...
function PostWorks(name, head, title, titleInfo, tags, post) {
    this.name = name;
    this.head = head;
    this.title = title;
...
PostWorks.prototype.save = function (callback) {
    ...
    mongodb.open(function (err, db) {
        ...
        //读取 posts 集合
        db.collection('postWorks', function (err, collection) {
            if (err) {
                db.close();
                return callback(err);
            }
...
//一次获取十篇文章
PostWorks.getTen = function (name, page, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
PostWorks.getOne = function (name, day, title, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
PostWorks.gOne = function (id, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
PostWorks.edit = function (id, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
//更新一篇文章及其相关信息
PostWorks.update = function (id, data, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
//删除一篇文章
PostWorks.remove = function (id, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
//删除一个评论
PostWorks.removeComment = function (name, id, index, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
            if (err) {
                return callback(err);
...
//返回所有文章存档信息
PostWorks.getArchive = function (callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
...
//返回所有标签
PostWorks.getTags = function (callback) {
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
        }
...
//返回含有特定标签的所有文章
PostWorks.getTag = function (tag, callback) {
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
        }
...
//返回通过标题关键字查询的所有文章信息
PostWorks.search = function (keyword, callback) {
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
        }
